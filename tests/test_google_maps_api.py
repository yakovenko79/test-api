...
class Test_create_place():
    ...
    def test_create_new_place(self):
        ...
        print("Метод PUT")
        result_update = Google_maps_api.update_new_place(place_id)
        Checking.check_status_code(result_update, 200)
        Checking.check_json_token(result_update, ['msg'])
        Checking.check_json_value(result_update, 'msg', "Address successfully updated")
